...
void main(void)
{
  //criando uma matrix de escala 2D
  mat3 model = mat3(1.5, 0.0, 0.0,  //primeira coluna
                    0.0, 1.5, 0.0,  //segunda coluna
                    0.0, 0.0, 1.0); //terceira coluna

  //multiplicando a matrix de transformacao pelo vetor
